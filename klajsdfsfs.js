...
const phrases = {
    ...
    am: {
        ...
        agreement: "🔒 ይህን ቦት በመጠቀም፣ ያስገቡት መረጃዎ ለሌሎች ተጠቃሚዎች ለማዛመድ እንደሚታይ ተስማምተዋል።",
        ...
        bio_invalid: '💡 እባክዎ አርስዎን አጠር አርገው ይግለጹ ።',
        username_prompt: '🔗 እባክዎ የ ቴሌግራም username ያስገቡ    ።',
        no_telegram_username: '👀 የቴሌግራም username  አልተገኘም። ለማሳየት የሚፈልጉትን username  ያስገቡ:',
        username_platform_prompt: '📱 ይህ username ከየትኛው socialmedia app ነው?',
        platform_name_prompt: '🗂 እባክዎ socialmedia ስም ያስገቡ:',
        platform_name_invalid: '🗂 እባክዎ socialmedia ስም ያስገቡ።',
        photo_prompt: '📸 እባክዎ የግል ፎቶ ይላኩ:',
        ...
        where_to_match_location: '🌍 your match  ከየት እንዲሆን ይፈልጋሉ? አካባቢ ይምረጡ ወይም የራስዎን ይጻፉ።',
        any_location: '🌐 ማንኛውም አካባቢ',
        daily_match_limit: '🔔 በቀን የሚፈቀደው 2 match ላይ ደርሰዋል። ነገ እንደገና ይሞክሩ ወይም የተለየ ቦታ ይምረጡ!',
        no_matches_found: '🔔 በዚያ አካባቢ ምንም match አልተገኘም። ሌላ ይሞክሩ ወይም በኋላ ይመልከቱ።',
        no_more_new_matches: '🔔 ለዛሬ ተጨማሪ አዲስ match የሉም። ለተጨማሪ ነገ ይመለሱ !',
        here_are_your_matches: '👫  here are your matches:',
        see_contact: '📞 ለማግኘት መረጃ ይመልከቱ',
        ice_breaker: ' መክፈቻ ቃላት',
        user_contact_not_found: '❌ የተጠቃሚ መረጃ ማግኘት አልተቻለም።',
        contact_info: '📞 የእውቂያ መረጃ:',
        ice_breaker_for: '💬 መክፈቻ ቃላት ለ ',
        show_profile: '👤 ፕሮፋይል አሳይ',
        edit_profile: '✏️ ፕሮፋይል አስተካክል',
        delete_profile: '🗑️ ፕሮፋይል ሰርዝ',
        help: '💬 እገዛ',
        help_text: 'ℹ️ ፕሮፋይልዎን በማስገባት እና 👀 See matches በመጫን match ያግኙ!',
        name_display: '👤 ስም: ',
        gender_display: '🚻 ፆታ: ',
        age_display: '🎂 ዕድሜ: ',
